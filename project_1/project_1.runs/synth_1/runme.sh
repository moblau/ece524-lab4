...
HD_PWD='C:/Users/joeba/OneDrive/Documents/524lab/4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log averager_50.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source averager_50.tcl
