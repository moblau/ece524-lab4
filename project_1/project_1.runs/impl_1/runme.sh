...
HD_PWD='C:/Users/joeba/OneDrive/Documents/524lab/4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log averager_50.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source averager_50.tcl -notrace
